  ...
  <div class="container">
    ...
    <div class="forum-cats">
      ...
      $forum_cats = [
          ...
          ['icon' => '<img src="' . esc_url(BJ_CHILD_URI . '/assets/img/logo-icon.png') . '" alt="" style="width:28px;height:28px;object-fit:contain;border-radius:50%">', 'title' => 'جوجه‌کشی', 'desc' => 'تنظیمات انکوباتور، درصد جوجه‌درآوری و مشکلات هچ'],
