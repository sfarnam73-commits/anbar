...
The visual preview now matches the dark navy/gold lawyer hero concept. Put the portrait image at `assets/images/dr-cheraghi-portrait.png` before opening the preview.
